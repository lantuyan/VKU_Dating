...
import 'package:ally_4_u_client/information.dart';
import 'package:ally_4_u_client/models/user.model.dart';
import 'package:ally_4_u_client/report.user.dart';
import 'package:ally_4_u_client/screens/calling/dial.dart';
import 'package:ally_4_u_client/screens/chat/large.image.dart';
...
class ChatPageUpdate extends StatefulWidget {
  final User sender;
  final String? chatId;
  final User second;
  ...
  @override
  State<ChatPageUpdate> createState() => _ChatPageUpdateState();
}

class _ChatPageUpdateState extends State<ChatPageUpdate> {
  ...
  checkblock() {
    chatReference.doc('blocked').snapshots().listen(
      (onData) {
        blockedBy = onData.data().toString().contains('blockedBy')
            ? onData.get('blockedBy')
            : '';
        if (onData.data().toString().contains('blockedBy') &&
            onData.get('blockedBy')) {
          isBlocked = true;
        } else {
          isBlocked = false;
                ...
                child: documentSnapshot.get('image_url') != ''
                    ...
                    : Bubble(
                        ...
                        style: BubbleStyle(
                          ...
                          // color: Colors.green,
                          color: darkPinkColor.withOpacity(0.8),
                          elevation: 0,
                        ),
                        child: Column(
                          children: [
  ...
  /// this for showing reciver chat layout
                        ...
                        child: InkWell(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                documentSnapshot.data()["time"]?.toDate() != null
                                    ? DateFormat.yMMMd()
                                        .add_jm()
  ...
  /// this method for generating layout for reciver
  ...
  /// this method generate the messag
          ...
          (doc) => Container(
            ...
            child: Row(
              ...
              children: doc.get('type') == "Call"
                  ? [
                      /// this for video call or phone call time
                      Bubble(
      ...
      builder: (context, ThemeNotifier notifier, child) => SafeArea(
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            // backgroundColor: lightPinkColor.withOpacity(0.9),
            backgroundColor: darkPinkColor.withOpacity(0.9),
            centerTitle: false,
            elevation: 1,
            title: Column(
